...
public class StudentDAO {
	...
	public List<StuGradeDTO> stuNoSearch(int in, Connection con) {
				
		List<StuGradeDTO> gradeList = new ArrayList<StuGradeDTO>();
		...
		try {
			...
			while (rs.next()) {
				...
				gradeList.add(new StuGradeDTO(termNo,stuName, stuNo, className, point, grade));
	...
	public List<StudentDTO> nameSearch(String findName, Connection con) {
		List<StudentDTO> list = new ArrayList<StudentDTO>();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		try {
			...
			try {
				...
				System.err.println("DAO close err : " + e2.getMessage());
			}
		} // tyr-catch-finally end

		return list;
	}// nameSerch end

	public List<StudentDTO> dateSearch(int start, int end, Connection con) {
		List<StudentDTO> list = new ArrayList<StudentDTO>();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
