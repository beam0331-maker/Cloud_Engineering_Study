...
public class Emp {
	...
	public Emp(int empno, String username, String job, int mgr, String hiredate, int salary, int commtssion,
			int deptno) {
		this.empno = empno;
	...
	public void setCommission(int commtssion) {
		this.commission = commtssion;
	}
