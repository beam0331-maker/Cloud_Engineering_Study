...
public class StudentDTO {
	...
	public StudentDTO(String stuNo, String departNo, String stuName, String stuSsn, String stuAddress, String date,
	...
	public String toString() {
		return "WorkShopDTO [stuNo=" + stuNo + ", departNo=" + departNo + ", stuName=" + stuName + ", stuSsn=" + stuSsn
				+ ", stuAddress=" + stuAddress + ", Date=" + Date + ", absYn=" + absYn + ", coachProfessorNo="
				+ coachProfessorNo + "]";
	}	
